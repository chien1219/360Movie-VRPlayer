...
public delegate void ClickedEventHandler1(object sender, ClickedEventArgs e);
...
public class SteamVR_TrackedController : MonoBehaviour
{
	...
	public virtual void OnGripped(ClickedEventArgs e)
	{
        ...
        else
        {
            ...
            Vector3 new_position = camera_eye.transform.position + 2 * camera_eye.transform.forward;
            //Vector3 offset = (camera_eye.transform.position - new_position) * 0.99f;

            Canvas.transform.up = camera_eye.transform.up;
            Canvas.transform.forward = camera_eye.transform.right;
        
            Canvas.transform.position = new_position;

            //Canvas.transform.localScale = new Vector3(2,2,2);
            
            //http://answers.unity3d.com/questions/1296984/moving-an-object-forward-relative-to-vive-controll.html
